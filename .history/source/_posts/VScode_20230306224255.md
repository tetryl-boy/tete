...
## Background
Carrying a disk around is not a elegant way for coding. The best way for coding is not on you personal devices, it should be on the cloud, not only for better perserving but also for the same computer environment. With a onling IDE, you can even code on you Ipad. Such a cool thing!
